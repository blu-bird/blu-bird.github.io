...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="/assets/img/posts/hott/circle.png" class="img-fluid rounded z-depth-1" alt="A circle labeled 'loop', with a point labeled with `pt` at the bottom."%}
    </div>
</div>
</div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="/assets/img/posts/hott/square.png" class="img-fluid rounded z-depth-1" alt="A square. The top and bottom edges are colored red, labeled 'a', and have arrows pointing to the right. The left and right edges are colored blue, labeled 'b', and have arrows pointing down."%}
    </div>
</div>
</div>
</div>
...
<div class="row mt-3">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.html path="/assets/img/posts/hott/torus.png" class="img-fluid rounded z-depth-1" alt="A torus (or a donut). The large circle that the donut forms around its hole is labeled 'b'; the small circle that wraps around the donut's cross-section is labeled 'a'."%}
    </div>
</div>
</div>
</div>
